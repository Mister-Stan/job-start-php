...
<header class="bg-blue-800 text-white p-4">
  <div class="container mx-auto flex flex-wrap justify-between items-center">
    ...
    <nav class="space-x-4 flex flex-wrap items-center mt-4 md:mt-0">
      ...
      <a href="/test-project/workopia/public/listings/create" class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300 whitespace-nowrap">
