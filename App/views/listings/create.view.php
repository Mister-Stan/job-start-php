...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        <h2 class="text-4xl text-center mb-4">Create Job Listing</h2>
        <form method="POST" action="/test-project/workopia/public/listings">
            <h2 class="text-2xl mb-6 text-center text-gray-500">Job Info</h2>
